...
//     try {
//       const token = localStorage.getItem('token');
//       const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://streammall-backend-73a4b072d5eb.herokuapp.com/api'}/live/${streamId}/purchase-with-coins`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//           ...(token && { 'Authorization': `Bearer ${token}` })
...
// === NEW: Stream Ended Modal ===
// === NEW: Stream Ended Modal with Stats ===
...
const ViewerLiveStream = ({ streamId, onBack }) => {
  ...
  const initializeSocket = () => {
    ...
    // === UPDATED: Full stream end data from backend ===
