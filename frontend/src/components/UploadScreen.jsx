...
const UploadScreen = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const signedUrlResponse = await fetch("https://streammall-backend-73a4b072d5eb.herokuapp.com/api/videos/signed-url", {
        method: 'POST',
        headers: {
      ...
      const saveResponse = await fetch("https://streammall-backend-73a4b072d5eb.herokuapp.com/api/videos/save", {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
